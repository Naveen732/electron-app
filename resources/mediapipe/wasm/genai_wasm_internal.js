  ...
  return async function (moduleArg = {}) {
    ...
    var SYSCALLS = {
      ...
      writeStatFs(buf, stats) {
        ...
        ;((tempI64 = [
          ...
          (HEAP32[((buf + 8) >>> 2) >>> 0] = tempI64[0]),
          (HEAP32[((buf + 12) >>> 2) >>> 0] = tempI64[1]))
        ;((tempI64 = [
          stats.bfree >>> 0,
          ...
          (HEAP32[((buf + 16) >>> 2) >>> 0] = tempI64[0]),
          (HEAP32[((buf + 20) >>> 2) >>> 0] = tempI64[1]))
        ;((tempI64 = [
          stats.bavail >>> 0,
        ...
        ;((tempI64 = [
          ...
          (HEAP32[((buf + 32) >>> 2) >>> 0] = tempI64[0]),
          (HEAP32[((buf + 36) >>> 2) >>> 0] = tempI64[1]))
        ;((tempI64 = [
          stats.ffree >>> 0,
    ...
    function _clock_time_get(clk_id, ignored_precision_low, ignored_precision_high, ptime) {
      ...
      ;((tempI64 = [
        ...
        (HEAP32[(ptime >>> 2) >>> 0] = tempI64[0]),
        (HEAP32[((ptime + 4) >>> 2) >>> 0] = tempI64[1]))
      return 0
    }
    ...
    var WebGPU = {
      ...
      fillLimitStruct: (limits, limitsOutPtr) => {
        function setLimitValueU32(name, limitOffset) {
          ...
          HEAPU32[((limitsOutPtr + limitOffset) >>> 2) >>> 0] = limitValue
        }
    ...
    var emscriptenWebGLGetTexPixelData = (type, format, width, height, pixels, internalFormat) => {
      ...
      return heap.subarray(
        toTypedArrayIndex(pixels, heap) >>> 0,
        toTypedArrayIndex(pixels + bytes, heap) >>> 0
      )
    }
    ...
    function _wgpuCommandEncoderResolveQuerySet(
      ...
      queryCount,
      destinationPtr,
      destinationOffset_low,
      destinationOffset_high
    ) {
      encoderPtr >>>= 0
      querySetPtr >>>= 0
      destinationPtr >>>= 0
      var destinationOffset = convertI32PairToI53Checked(
        destinationOffset_low,
        destinationOffset_high
      )
      var commandEncoder = WebGPU.getJsObject(encoderPtr)
    ...
    var _wgpuQueueSubmit = function (queuePtr, commandCount, commands) {
      ...
      var queue = WebGPU.getJsObject(queuePtr)
      var cmds = Array.from(
        HEAP32.subarray((commands >>> 2) >>> 0, ((commands + commandCount * 4) >>> 2) >>> 0),
    ...
    var ASM_CONSTS = {
      2010712: () => !!Module['preinitializedWebGPUDevice'],
      2010763: () => {
      ...
      2010946: () => !!Module['preinitializedWebGPUDevice'],
      2010997: () => {
    ...
    var _free,
      _CreateLlmInferenceEngineConverted,
      _DeleteLlmInferenceEngine,
    ...
    function assignWasmExports(wasmExports) {
      _free = Module['_free'] = wasmExports['wc']
      _CreateLlmInferenceEngineConverted = Module['_CreateLlmInferenceEngineConverted'] =
        wasmExports['xc']
      _DeleteLlmInferenceEngine = Module['_DeleteLlmInferenceEngine'] = wasmExports['yc']
      _MakeSessionForPredict = Module['_MakeSessionForPredict'] = wasmExports['zc']
      _AddTextQueryChunk = Module['_AddTextQueryChunk'] = wasmExports['Ac']
      _AddImageQueryChunk = Module['_AddImageQueryChunk'] = wasmExports['Bc']
      _AddAudioQueryChunk = Module['_AddAudioQueryChunk'] = wasmExports['Cc']
      _malloc = Module['_malloc'] = wasmExports['Dc']
      _PredictSession = Module['_PredictSession'] = wasmExports['Ec']
      _FreeSession = Module['_FreeSession'] = wasmExports['Fc']
      _GetSizeInTokens = Module['_GetSizeInTokens'] = wasmExports['Gc']
      _wgpuDeviceAddRef = wasmExports['Hc']
      _registerModelResourcesGraphService = Module['_registerModelResourcesGraphService'] =
        wasmExports['Ic']
      _bindTextureToStream = Module['_bindTextureToStream'] = wasmExports['Jc']
      _addBoundTextureToStream = Module['_addBoundTextureToStream'] = wasmExports['Kc']
      _addDoubleToInputStream = Module['_addDoubleToInputStream'] = wasmExports['Lc']
      _addFloatToInputStream = Module['_addFloatToInputStream'] = wasmExports['Mc']
      _addBoolToInputStream = Module['_addBoolToInputStream'] = wasmExports['Nc']
      _addIntToInputStream = Module['_addIntToInputStream'] = wasmExports['Oc']
      _addUintToInputStream = Module['_addUintToInputStream'] = wasmExports['Pc']
      _addStringToInputStream = Module['_addStringToInputStream'] = wasmExports['Qc']
      _addRawDataSpanToInputStream = Module['_addRawDataSpanToInputStream'] = wasmExports['Rc']
      _allocateBoolVector = Module['_allocateBoolVector'] = wasmExports['Sc']
      _allocateFloatVector = Module['_allocateFloatVector'] = wasmExports['Tc']
      _allocateDoubleVector = Module['_allocateDoubleVector'] = wasmExports['Uc']
      _allocateIntVector = Module['_allocateIntVector'] = wasmExports['Vc']
      _allocateUintVector = Module['_allocateUintVector'] = wasmExports['Wc']
      _allocateStringVector = Module['_allocateStringVector'] = wasmExports['Xc']
      _addBoolVectorEntry = Module['_addBoolVectorEntry'] = wasmExports['Yc']
      _addFloatVectorEntry = Module['_addFloatVectorEntry'] = wasmExports['Zc']
      _addDoubleVectorEntry = Module['_addDoubleVectorEntry'] = wasmExports['_c']
      _addIntVectorEntry = Module['_addIntVectorEntry'] = wasmExports['$c']
      _addUintVectorEntry = Module['_addUintVectorEntry'] = wasmExports['ad']
      _addStringVectorEntry = Module['_addStringVectorEntry'] = wasmExports['bd']
      _addBoolVectorToInputStream = Module['_addBoolVectorToInputStream'] = wasmExports['cd']
      _addFloatVectorToInputStream = Module['_addFloatVectorToInputStream'] = wasmExports['dd']
      _addDoubleVectorToInputStream = Module['_addDoubleVectorToInputStream'] = wasmExports['ed']
      _addIntVectorToInputStream = Module['_addIntVectorToInputStream'] = wasmExports['fd']
      _addUintVectorToInputStream = Module['_addUintVectorToInputStream'] = wasmExports['gd']
      _addStringVectorToInputStream = Module['_addStringVectorToInputStream'] = wasmExports['hd']
      _addFlatHashMapToInputStream = Module['_addFlatHashMapToInputStream'] = wasmExports['id']
      _addProtoToInputStream = Module['_addProtoToInputStream'] = wasmExports['jd']
      _addEmptyPacketToInputStream = Module['_addEmptyPacketToInputStream'] = wasmExports['kd']
      _addBoolToInputSidePacket = Module['_addBoolToInputSidePacket'] = wasmExports['ld']
      _addDoubleToInputSidePacket = Module['_addDoubleToInputSidePacket'] = wasmExports['md']
      _addFloatToInputSidePacket = Module['_addFloatToInputSidePacket'] = wasmExports['nd']
      _addIntToInputSidePacket = Module['_addIntToInputSidePacket'] = wasmExports['od']
      _addUintToInputSidePacket = Module['_addUintToInputSidePacket'] = wasmExports['pd']
      _addStringToInputSidePacket = Module['_addStringToInputSidePacket'] = wasmExports['qd']
      _addRawDataSpanToInputSidePacket = Module['_addRawDataSpanToInputSidePacket'] =
        wasmExports['rd']
      _addProtoToInputSidePacket = Module['_addProtoToInputSidePacket'] = wasmExports['sd']
      ...
      _addFloatVectorToInputSidePacket = Module['_addFloatVectorToInputSidePacket'] =
        wasmExports['vd']
      _addIntVectorToInputSidePacket = Module['_addIntVectorToInputSidePacket'] = wasmExports['wd']
      ...
      _addStringVectorToInputSidePacket = Module['_addStringVectorToInputSidePacket'] =
        wasmExports['yd']
      _attachBoolListener = Module['_attachBoolListener'] = wasmExports['zd']
      _attachBoolVectorListener = Module['_attachBoolVectorListener'] = wasmExports['Ad']
      _attachDoubleListener = Module['_attachDoubleListener'] = wasmExports['Bd']
      _attachDoubleVectorListener = Module['_attachDoubleVectorListener'] = wasmExports['Cd']
      _attachFloatListener = Module['_attachFloatListener'] = wasmExports['Dd']
      _attachFloatVectorListener = Module['_attachFloatVectorListener'] = wasmExports['Ed']
      _attachIntListener = Module['_attachIntListener'] = wasmExports['Fd']
      _attachIntVectorListener = Module['_attachIntVectorListener'] = wasmExports['Gd']
      _attachUintListener = Module['_attachUintListener'] = wasmExports['Hd']
      _attachUintVectorListener = Module['_attachUintVectorListener'] = wasmExports['Id']
      _attachStringListener = Module['_attachStringListener'] = wasmExports['Jd']
      _attachStringVectorListener = Module['_attachStringVectorListener'] = wasmExports['Kd']
      _attachProtoListener = Module['_attachProtoListener'] = wasmExports['Ld']
      _attachProtoVectorListener = Module['_attachProtoVectorListener'] = wasmExports['Md']
      _getGraphConfig = Module['_getGraphConfig'] = wasmExports['Nd']
      ___getTypeName = wasmExports['Od']
      _emwgpuCreateBindGroup = wasmExports['Pd']
      _emwgpuCreateBindGroupLayout = wasmExports['Qd']
      _emwgpuCreateCommandBuffer = wasmExports['Rd']
      _emwgpuCreateCommandEncoder = wasmExports['Sd']
      _emwgpuCreateComputePassEncoder = wasmExports['Td']
      _emwgpuCreateComputePipeline = wasmExports['Ud']
      _emwgpuCreateExternalTexture = wasmExports['Vd']
      _emwgpuCreatePipelineLayout = wasmExports['Wd']
      _emwgpuCreateQuerySet = wasmExports['Xd']
      _emwgpuCreateRenderBundle = wasmExports['Yd']
      _emwgpuCreateRenderBundleEncoder = wasmExports['Zd']
      _emwgpuCreateRenderPassEncoder = wasmExports['_d']
      _emwgpuCreateRenderPipeline = wasmExports['$d']
      _emwgpuCreateSampler = wasmExports['ae']
      _emwgpuCreateSurface = wasmExports['be']
      _emwgpuCreateTexture = wasmExports['ce']
      _emwgpuCreateTextureView = wasmExports['de']
      _emwgpuCreateAdapter = wasmExports['ee']
      _emwgpuCreateBuffer = wasmExports['fe']
      _emwgpuCreateDevice = wasmExports['ge']
      _emwgpuCreateQueue = wasmExports['he']
      _emwgpuCreateShaderModule = wasmExports['ie']
      _emwgpuOnCreateComputePipelineCompleted = wasmExports['je']
      _emwgpuOnWorkDoneCompleted = wasmExports['ke']
      _clearSubgraphs = Module['_clearSubgraphs'] = wasmExports['le']
      _pushBinarySubgraph = Module['_pushBinarySubgraph'] = wasmExports['me']
      _pushTextSubgraph = Module['_pushTextSubgraph'] = wasmExports['ne']
      _changeBinaryGraph = Module['_changeBinaryGraph'] = wasmExports['oe']
      _changeTextGraph = Module['_changeTextGraph'] = wasmExports['pe']
      _processGl = Module['_processGl'] = wasmExports['qe']
      _process = Module['_process'] = wasmExports['re']
      ...
      _emscripten_builtin_memalign = wasmExports['xe']
      _memalign = wasmExports['ye']
      __emscripten_tempret_set = wasmExports['ze']
      __emscripten_stack_restore = wasmExports['Ae']
      __emscripten_stack_alloc = wasmExports['Be']
      _emscripten_stack_get_current = wasmExports['Ce']
      dynCall_vii = dynCalls['vii'] = wasmExports['De']
      dynCall_viiiiiii = dynCalls['viiiiiii'] = wasmExports['Ee']
      dynCall_viiiiii = dynCalls['viiiiii'] = wasmExports['Fe']
      dynCall_v = dynCalls['v'] = wasmExports['Ge']
      dynCall_ii = dynCalls['ii'] = wasmExports['He']
      dynCall_vi = dynCalls['vi'] = wasmExports['Ie']
      dynCall_iiiii = dynCalls['iiiii'] = wasmExports['Je']
      dynCall_iii = dynCalls['iii'] = wasmExports['Ke']
      dynCall_i = dynCalls['i'] = wasmExports['Le']
      dynCall_viii = dynCalls['viii'] = wasmExports['Me']
      dynCall_ji = dynCalls['ji'] = wasmExports['Ne']
      dynCall_iiii = dynCalls['iiii'] = wasmExports['Oe']
      dynCall_viiii = dynCalls['viiii'] = wasmExports['Pe']
      dynCall_viiiii = dynCalls['viiiii'] = wasmExports['Qe']
      dynCall_jii = dynCalls['jii'] = wasmExports['Re']
      dynCall_iiiijij = dynCalls['iiiijij'] = wasmExports['Se']
      dynCall_fif = dynCalls['fif'] = wasmExports['Te']
      dynCall_ff = dynCalls['ff'] = wasmExports['Ue']
      dynCall_did = dynCalls['did'] = wasmExports['Ve']
      dynCall_iiiiiii = dynCalls['iiiiiii'] = wasmExports['We']
      dynCall_iiiiii = dynCalls['iiiiii'] = wasmExports['Xe']
      dynCall_iiiiiiiiiii = dynCalls['iiiiiiiiiii'] = wasmExports['Ye']
      dynCall_iiiiiiiiiiii = dynCalls['iiiiiiiiiiii'] = wasmExports['Ze']
      dynCall_iiiijj = dynCalls['iiiijj'] = wasmExports['_e']
      dynCall_viijj = dynCalls['viijj'] = wasmExports['$e']
      dynCall_viiijjj = dynCalls['viiijjj'] = wasmExports['af']
      dynCall_viji = dynCalls['viji'] = wasmExports['bf']
      dynCall_vijiii = dynCalls['vijiii'] = wasmExports['cf']
      dynCall_iiiiiiiii = dynCalls['iiiiiiiii'] = wasmExports['df']
      dynCall_viiiiiiii = dynCalls['viiiiiiii'] = wasmExports['ef']
      dynCall_iiiif = dynCalls['iiiif'] = wasmExports['ff']
      dynCall_viiiiiiiiiiiiiii = dynCalls['viiiiiiiiiiiiiii'] = wasmExports['gf']
      dynCall_viff = dynCalls['viff'] = wasmExports['hf']
      dynCall_viiffii = dynCalls['viiffii'] = wasmExports['jf']
      dynCall_viiffi = dynCalls['viiffi'] = wasmExports['kf']
      dynCall_viiiiiiiiii = dynCalls['viiiiiiiiii'] = wasmExports['lf']
      dynCall_fi = dynCalls['fi'] = wasmExports['mf']
      dynCall_viiffff = dynCalls['viiffff'] = wasmExports['nf']
      dynCall_viiiiij = dynCalls['viiiiij'] = wasmExports['of']
      dynCall_vij = dynCalls['vij'] = wasmExports['pf']
      dynCall_viiiiiffii = dynCalls['viiiiiffii'] = wasmExports['qf']
      dynCall_vif = dynCalls['vif'] = wasmExports['rf']
      dynCall_ddd = dynCalls['ddd'] = wasmExports['sf']
      dynCall_dddd = dynCalls['dddd'] = wasmExports['tf']
      dynCall_idd = dynCalls['idd'] = wasmExports['uf']
      dynCall_di = dynCalls['di'] = wasmExports['vf']
      dynCall_jiiiijiiiii = dynCalls['jiiiijiiiii'] = wasmExports['wf']
      dynCall_viiij = dynCalls['viiij'] = wasmExports['xf']
      dynCall_viid = dynCalls['viid'] = wasmExports['yf']
      dynCall_vidd = dynCalls['vidd'] = wasmExports['zf']
      dynCall_vifd = dynCalls['vifd'] = wasmExports['Af']
      dynCall_viiiiiiiiiii = dynCalls['viiiiiiiiiii'] = wasmExports['Bf']
      dynCall_iiif = dynCalls['iiif'] = wasmExports['Cf']
      dynCall_jiii = dynCalls['jiii'] = wasmExports['Df']
      dynCall_fff = dynCalls['fff'] = wasmExports['Ef']
      dynCall_viifii = dynCalls['viifii'] = wasmExports['Ff']
      dynCall_fii = dynCalls['fii'] = wasmExports['Gf']
      dynCall_jjj = dynCalls['jjj'] = wasmExports['Hf']
      dynCall_iiiiiiiiii = dynCalls['iiiiiiiiii'] = wasmExports['If']
      dynCall_viiiiiiiii = dynCalls['viiiiiiiii'] = wasmExports['Jf']
      dynCall_viiiffii = dynCalls['viiiffii'] = wasmExports['Kf']
      dynCall_iiiiiffi = dynCalls['iiiiiffi'] = wasmExports['Lf']
      dynCall_viiiiiff = dynCalls['viiiiiff'] = wasmExports['Mf']
      dynCall_viiiiiiiiiiiii = dynCalls['viiiiiiiiiiiii'] = wasmExports['Nf']
      dynCall_viiiiiiiiiiii = dynCalls['viiiiiiiiiiii'] = wasmExports['Of']
      dynCall_viiiiiiiiiiiiiiiii = dynCalls['viiiiiiiiiiiiiiiii'] = wasmExports['Pf']
      dynCall_iifff = dynCalls['iifff'] = wasmExports['Qf']
      dynCall_iiff = dynCalls['iiff'] = wasmExports['Rf']
      dynCall_iiifiii = dynCalls['iiifiii'] = wasmExports['Sf']
      dynCall_iiffi = dynCalls['iiffi'] = wasmExports['Tf']
      dynCall_iiffii = dynCalls['iiffii'] = wasmExports['Uf']
      dynCall_viiiiiiiiiiiiii = dynCalls['viiiiiiiiiiiiii'] = wasmExports['Vf']
      dynCall_iif = dynCalls['iif'] = wasmExports['Wf']
      dynCall_viijii = dynCalls['viijii'] = wasmExports['Xf']
      dynCall_iiiji = dynCalls['iiiji'] = wasmExports['Yf']
      dynCall_viiif = dynCalls['viiif'] = wasmExports['Zf']
      dynCall_viiifiii = dynCalls['viiifiii'] = wasmExports['_f']
      dynCall_fiif = dynCalls['fiif'] = wasmExports['$f']
      dynCall_iiiifi = dynCalls['iiiifi'] = wasmExports['ag']
      dynCall_iiiifiii = dynCalls['iiiifiii'] = wasmExports['bg']
      dynCall_iiifi = dynCalls['iiifi'] = wasmExports['cg']
      dynCall_viiiif = dynCalls['viiiif'] = wasmExports['dg']
      dynCall_viiiifii = dynCalls['viiiifii'] = wasmExports['eg']
      dynCall_dii = dynCalls['dii'] = wasmExports['fg']
      dynCall_vifi = dynCalls['vifi'] = wasmExports['gg']
      dynCall_vidi = dynCalls['vidi'] = wasmExports['hg']
      dynCall_viiiji = dynCalls['viiiji'] = wasmExports['ig']
      dynCall_viiji = dynCalls['viiji'] = wasmExports['jg']
      dynCall_vijjj = dynCalls['vijjj'] = wasmExports['kg']
      dynCall_vj = dynCalls['vj'] = wasmExports['lg']
      dynCall_viij = dynCalls['viij'] = wasmExports['mg']
      dynCall_jiji = dynCalls['jiji'] = wasmExports['ng']
      dynCall_iidiiii = dynCalls['iidiiii'] = wasmExports['og']
      dynCall_iiiiij = dynCalls['iiiiij'] = wasmExports['pg']
      dynCall_iiiiid = dynCalls['iiiiid'] = wasmExports['qg']
      dynCall_iiiiijj = dynCalls['iiiiijj'] = wasmExports['rg']
      dynCall_iiiiiiii = dynCalls['iiiiiiii'] = wasmExports['sg']
      dynCall_iiiiiijj = dynCalls['iiiiiijj'] = wasmExports['tg']
      _asyncify_start_unwind = wasmExports['ug']
      _asyncify_stop_unwind = wasmExports['vg']
      _asyncify_start_rewind = wasmExports['wg']
      _asyncify_stop_rewind = wasmExports['xg']
      memory = wasmMemory = wasmExports['uc']
    ...
    var _kVersionStampPrecookedClientInfoStr = (Module['_kVersionStampPrecookedClientInfoStr'] =
      9104)
    var wasmImports = {
      sc: DefaultErrorReporter,
      rc: GetAdapterArchitecture,
      qc: GetAdapterDescription,
      pc: GetAdapterDeviceName,
      oc: GetAdapterVendor,
      mc: JsGetDeviceMaxSubgroupSize,
      lc: JsGetDeviceMinSubgroupSize,
      kc: JsOnEmptyPacketListener,
      qa: JsOnSimpleListenerBinaryArray,
      jc: JsOnSimpleListenerBool,
      ic: JsOnSimpleListenerDouble,
      hc: JsOnSimpleListenerFloat,
      gc: JsOnSimpleListenerInt,
      fc: JsOnSimpleListenerString,
      ec: JsOnSimpleListenerUint,
      p: JsOnVectorFinishedListener,
      dc: JsOnVectorListenerBool,
      cc: JsOnVectorListenerDouble,
      bc: JsOnVectorListenerFloat,
      ac: JsOnVectorListenerInt,
      $b: JsOnVectorListenerProto,
      _b: JsOnVectorListenerString,
      Zb: JsOnVectorListenerUint,
      pa: JsProgressListener,
      L: JsWrapErrorListener,
      g: JsWrapSimpleListeners,
      Yb: ThrowError,
      oa: UseBottomLeftGpuOrigin,
      tc: __asyncjs__CallReadDataFn,
      nc: __asyncjs__InvokeReadDataFn,
      K: __asyncjs__ReadBufferDataJs,
      Ea: __asyncjs__mediapipe_map_buffer_jspi,
      Xb: ___cxa_throw,
      Wb: ___syscall_dup,
      Vb: ___syscall_faccessat,
      na: ___syscall_fcntl64,
      Ub: ___syscall_fstat64,
      Ua: ___syscall_ftruncate64,
      Tb: ___syscall_getcwd,
      Sb: ___syscall_getdents64,
      Rb: ___syscall_ioctl,
      Qb: ___syscall_lstat64,
      Pb: ___syscall_mkdirat,
      Ob: ___syscall_newfstatat,
      ma: ___syscall_openat,
      Nb: ___syscall_renameat,
      Mb: ___syscall_stat64,
      Gb: __abort_js,
      Ra: __embind_register_bigint,
      Fb: __embind_register_bool,
      Eb: __embind_register_emval,
      ka: __embind_register_float,
      ...
      ja: __emval_create_invoker,
      h: __emval_decref,
      o: __emval_incref,
      ia: __emval_invoke,
      ha: __emval_run_destructors,
      Qa: __gmtime_js,
      Pa: __localtime_js,
      Oa: __mktime_js,
      Na: __mmap_js,
      ...
      zb: _emscripten_date_now,
      I: _emscripten_errn,
      yb: _emscripten_get_heap_max,
      b: _emscripten_get_now,
      ga: _emscripten_has_asyncify,
      xb: _emscripten_outn,
      wb: _emscripten_pc_get_function,
      vb: _emscripten_resize_heap,
      fa: _emscripten_stack_snapshot,
      ub: _emscripten_stack_unwind_buffer,
      tb: _emscripten_webgl_create_context,
      sb: _emscripten_webgl_destroy_context,
      rb: _emscripten_webgl_get_context_attributes,
      r: _emscripten_webgl_get_current_context,
      qb: _emscripten_webgl_make_context_current,
      ea: _emscripten_webgpu_get_device,
      pb: _emwgpuBufferDestroy,
      ob: _emwgpuBufferGetMappedRange,
      nb: _emwgpuBufferUnmap,
      mb: _emwgpuBufferWriteMappedRange,
      f: _emwgpuDelete,
      lb: _emwgpuDeviceCreateBuffer,
      La: _emwgpuDeviceCreateComputePipelineAsync,
      kb: _emwgpuDeviceCreateShaderModule,
      jb: _emwgpuDeviceDestroy,
      ...
      eb: _glCreateProgram,
      db: _glCreateShader,
      ca: _glDeleteFramebuffers,
      cb: _glDeleteProgram,
      ba: _glDeleteShader,
      v: _glDeleteSync,
      aa: _glDeleteTextures,
      $: _glDetachShader,
      _: _glDisableVertexAttribArray,
      bb: _glDrawArrays,
      ...
      j: _wgpuCommandEncoderBeginComputePass,
      Ha: _wgpuCommandEncoderCopyBufferToBuffer,
      S: _wgpuCommandEncoderCopyTextureToBuffer,
      R: _wgpuCommandEncoderCopyTextureToTexture,
      d: _wgpuCommandEncoderFinish,
      Ga: _wgpuCommandEncoderResolveQuerySet,
      Q: _wgpuComputePassEncoderDispatchWorkgroups,
      i: _wgpuComputePassEncoderEnd,
      Da: _wgpuComputePassEncoderSetBindGroup,
      P: _wgpuComputePassEncoderSetPipeline,
      Ca: _wgpuDeviceCreateBindGroup,
      Ba: _wgpuDeviceCreateBindGroupLayout,
      c: _wgpuDeviceCreateCommandEncoder,
      Aa: _wgpuDeviceCreateComputePipeline,
      za: _wgpuDeviceCreatePipelineLayout,
      ya: _wgpuDeviceCreateQuerySet,
      xa: _wgpuDeviceCreateTexture,
      O: _wgpuDeviceGetAdapterInfo,
      wa: _wgpuDeviceGetLimits,
      va: _wgpuDeviceHasFeature,
      a: _wgpuQueueSubmit,
      Fa: _wgpuQueueWriteBuffer,
      ua: _wgpuQueueWriteTexture,
      ta: _wgpuTextureCreateView,
      sa: _wgpuTextureDestroy,
      A: _wgpuTextureGetDepthOrArrayLayers,
      ra: _wgpuTextureGetFormat,
      N: _wgpuTextureGetHeight,
      M: _wgpuTextureGetWidth
    }
    function applySignatureConversions(wasmExports) {
      ...
      wasmExports['Od'] = makeWrapper_pp(wasmExports['Od'])
      wasmExports['xe'] = makeWrapper_ppp(wasmExports['xe'])
      wasmExports['ye'] = makeWrapper_ppp(wasmExports['ye'])
      wasmExports['Be'] = makeWrapper_pp(wasmExports['Be'])
      wasmExports['Ce'] = makeWrapper_p(wasmExports['Ce'])
      wasmExports['__cxa_get_exception_ptr'] = makeWrapper_pp(
        wasmExports['__cxa_get_exception_ptr']
      )
      return wasmExports
    }
    function run() {
