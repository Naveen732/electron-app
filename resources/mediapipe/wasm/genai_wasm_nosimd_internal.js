var ModuleFactory = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var ASM_CONSTS = {
      2010584: () => !!Module['preinitializedWebGPUDevice'],
      2010635: () => {
      ...
      2010818: () => !!Module['preinitializedWebGPUDevice'],
      2010869: () => {
    ...
    function assignWasmExports(wasmExports) {
      _free = Module['_free'] = wasmExports['vc']
      _CreateLlmInferenceEngineConverted = Module['_CreateLlmInferenceEngineConverted'] =
        wasmExports['wc']
      _DeleteLlmInferenceEngine = Module['_DeleteLlmInferenceEngine'] = wasmExports['xc']
      _MakeSessionForPredict = Module['_MakeSessionForPredict'] = wasmExports['yc']
      _AddTextQueryChunk = Module['_AddTextQueryChunk'] = wasmExports['zc']
      _AddImageQueryChunk = Module['_AddImageQueryChunk'] = wasmExports['Ac']
      _AddAudioQueryChunk = Module['_AddAudioQueryChunk'] = wasmExports['Bc']
      _malloc = Module['_malloc'] = wasmExports['Cc']
      _PredictSession = Module['_PredictSession'] = wasmExports['Dc']
      _FreeSession = Module['_FreeSession'] = wasmExports['Ec']
      _GetSizeInTokens = Module['_GetSizeInTokens'] = wasmExports['Fc']
      _wgpuDeviceAddRef = wasmExports['Gc']
      _registerModelResourcesGraphService = Module['_registerModelResourcesGraphService'] =
        wasmExports['Hc']
      _bindTextureToStream = Module['_bindTextureToStream'] = wasmExports['Ic']
      _addBoundTextureToStream = Module['_addBoundTextureToStream'] = wasmExports['Jc']
      _addDoubleToInputStream = Module['_addDoubleToInputStream'] = wasmExports['Kc']
      _addFloatToInputStream = Module['_addFloatToInputStream'] = wasmExports['Lc']
      _addBoolToInputStream = Module['_addBoolToInputStream'] = wasmExports['Mc']
      _addIntToInputStream = Module['_addIntToInputStream'] = wasmExports['Nc']
      _addUintToInputStream = Module['_addUintToInputStream'] = wasmExports['Oc']
      _addStringToInputStream = Module['_addStringToInputStream'] = wasmExports['Pc']
      _addRawDataSpanToInputStream = Module['_addRawDataSpanToInputStream'] = wasmExports['Qc']
      _allocateBoolVector = Module['_allocateBoolVector'] = wasmExports['Rc']
      _allocateFloatVector = Module['_allocateFloatVector'] = wasmExports['Sc']
      _allocateDoubleVector = Module['_allocateDoubleVector'] = wasmExports['Tc']
      _allocateIntVector = Module['_allocateIntVector'] = wasmExports['Uc']
      _allocateUintVector = Module['_allocateUintVector'] = wasmExports['Vc']
      _allocateStringVector = Module['_allocateStringVector'] = wasmExports['Wc']
      _addBoolVectorEntry = Module['_addBoolVectorEntry'] = wasmExports['Xc']
      _addFloatVectorEntry = Module['_addFloatVectorEntry'] = wasmExports['Yc']
      _addDoubleVectorEntry = Module['_addDoubleVectorEntry'] = wasmExports['Zc']
      _addIntVectorEntry = Module['_addIntVectorEntry'] = wasmExports['_c']
      _addUintVectorEntry = Module['_addUintVectorEntry'] = wasmExports['$c']
      _addStringVectorEntry = Module['_addStringVectorEntry'] = wasmExports['ad']
      _addBoolVectorToInputStream = Module['_addBoolVectorToInputStream'] = wasmExports['bd']
      _addFloatVectorToInputStream = Module['_addFloatVectorToInputStream'] = wasmExports['cd']
      _addDoubleVectorToInputStream = Module['_addDoubleVectorToInputStream'] = wasmExports['dd']
      _addIntVectorToInputStream = Module['_addIntVectorToInputStream'] = wasmExports['ed']
      _addUintVectorToInputStream = Module['_addUintVectorToInputStream'] = wasmExports['fd']
      _addStringVectorToInputStream = Module['_addStringVectorToInputStream'] = wasmExports['gd']
      _addFlatHashMapToInputStream = Module['_addFlatHashMapToInputStream'] = wasmExports['hd']
      _addProtoToInputStream = Module['_addProtoToInputStream'] = wasmExports['id']
      _addEmptyPacketToInputStream = Module['_addEmptyPacketToInputStream'] = wasmExports['jd']
      _addBoolToInputSidePacket = Module['_addBoolToInputSidePacket'] = wasmExports['kd']
      _addDoubleToInputSidePacket = Module['_addDoubleToInputSidePacket'] = wasmExports['ld']
      _addFloatToInputSidePacket = Module['_addFloatToInputSidePacket'] = wasmExports['md']
      _addIntToInputSidePacket = Module['_addIntToInputSidePacket'] = wasmExports['nd']
      _addUintToInputSidePacket = Module['_addUintToInputSidePacket'] = wasmExports['od']
      _addStringToInputSidePacket = Module['_addStringToInputSidePacket'] = wasmExports['pd']
      _addRawDataSpanToInputSidePacket = Module['_addRawDataSpanToInputSidePacket'] =
        wasmExports['qd']
      _addProtoToInputSidePacket = Module['_addProtoToInputSidePacket'] = wasmExports['rd']
      ...
      _addFloatVectorToInputSidePacket = Module['_addFloatVectorToInputSidePacket'] =
        wasmExports['ud']
      _addIntVectorToInputSidePacket = Module['_addIntVectorToInputSidePacket'] = wasmExports['vd']
      ...
      _addStringVectorToInputSidePacket = Module['_addStringVectorToInputSidePacket'] =
        wasmExports['xd']
      _attachBoolListener = Module['_attachBoolListener'] = wasmExports['yd']
      _attachBoolVectorListener = Module['_attachBoolVectorListener'] = wasmExports['zd']
      _attachDoubleListener = Module['_attachDoubleListener'] = wasmExports['Ad']
      _attachDoubleVectorListener = Module['_attachDoubleVectorListener'] = wasmExports['Bd']
      _attachFloatListener = Module['_attachFloatListener'] = wasmExports['Cd']
      _attachFloatVectorListener = Module['_attachFloatVectorListener'] = wasmExports['Dd']
      _attachIntListener = Module['_attachIntListener'] = wasmExports['Ed']
      _attachIntVectorListener = Module['_attachIntVectorListener'] = wasmExports['Fd']
      _attachUintListener = Module['_attachUintListener'] = wasmExports['Gd']
      _attachUintVectorListener = Module['_attachUintVectorListener'] = wasmExports['Hd']
      _attachStringListener = Module['_attachStringListener'] = wasmExports['Id']
      _attachStringVectorListener = Module['_attachStringVectorListener'] = wasmExports['Jd']
      _attachProtoListener = Module['_attachProtoListener'] = wasmExports['Kd']
      _attachProtoVectorListener = Module['_attachProtoVectorListener'] = wasmExports['Ld']
      _getGraphConfig = Module['_getGraphConfig'] = wasmExports['Md']
      ___getTypeName = wasmExports['Nd']
      ...
      _emwgpuCreateRenderPipeline = wasmExports['_d']
      _emwgpuCreateSampler = wasmExports['$d']
      _emwgpuCreateSurface = wasmExports['ae']
      _emwgpuCreateTexture = wasmExports['be']
      _emwgpuCreateTextureView = wasmExports['ce']
      _emwgpuCreateAdapter = wasmExports['de']
      _emwgpuCreateBuffer = wasmExports['ee']
      _emwgpuCreateDevice = wasmExports['fe']
      _emwgpuCreateQueue = wasmExports['ge']
      _emwgpuCreateShaderModule = wasmExports['he']
      _emwgpuOnCreateComputePipelineCompleted = wasmExports['ie']
      _emwgpuOnWorkDoneCompleted = wasmExports['je']
      _clearSubgraphs = Module['_clearSubgraphs'] = wasmExports['ke']
      _pushBinarySubgraph = Module['_pushBinarySubgraph'] = wasmExports['le']
      _pushTextSubgraph = Module['_pushTextSubgraph'] = wasmExports['me']
      _changeBinaryGraph = Module['_changeBinaryGraph'] = wasmExports['ne']
      _changeTextGraph = Module['_changeTextGraph'] = wasmExports['oe']
      _processGl = Module['_processGl'] = wasmExports['pe']
      _process = Module['_process'] = wasmExports['qe']
      ...
      _emscripten_builtin_memalign = wasmExports['we']
      _memalign = wasmExports['xe']
      __emscripten_tempret_set = wasmExports['ye']
      ...
      dynCall_viiiiiii = dynCalls['viiiiiii'] = wasmExports['De']
      dynCall_viiiiii = dynCalls['viiiiii'] = wasmExports['Ee']
      dynCall_v = dynCalls['v'] = wasmExports['Fe']
      dynCall_ii = dynCalls['ii'] = wasmExports['Ge']
      dynCall_vi = dynCalls['vi'] = wasmExports['He']
      dynCall_iiiii = dynCalls['iiiii'] = wasmExports['Ie']
      dynCall_iii = dynCalls['iii'] = wasmExports['Je']
      dynCall_i = dynCalls['i'] = wasmExports['Ke']
      dynCall_viii = dynCalls['viii'] = wasmExports['Le']
      dynCall_ji = dynCalls['ji'] = wasmExports['Me']
      dynCall_iiii = dynCalls['iiii'] = wasmExports['Ne']
      dynCall_viiii = dynCalls['viiii'] = wasmExports['Oe']
      dynCall_viiiii = dynCalls['viiiii'] = wasmExports['Pe']
      dynCall_jii = dynCalls['jii'] = wasmExports['Qe']
      dynCall_iiiijij = dynCalls['iiiijij'] = wasmExports['Re']
      dynCall_fif = dynCalls['fif'] = wasmExports['Se']
      dynCall_ff = dynCalls['ff'] = wasmExports['Te']
      dynCall_did = dynCalls['did'] = wasmExports['Ue']
      dynCall_iiiiiii = dynCalls['iiiiiii'] = wasmExports['Ve']
      dynCall_iiiiii = dynCalls['iiiiii'] = wasmExports['We']
      dynCall_iiiiiiiiiii = dynCalls['iiiiiiiiiii'] = wasmExports['Xe']
      dynCall_iiiiiiiiiiii = dynCalls['iiiiiiiiiiii'] = wasmExports['Ye']
      dynCall_iiiijj = dynCalls['iiiijj'] = wasmExports['Ze']
      dynCall_viijj = dynCalls['viijj'] = wasmExports['_e']
      dynCall_viiijjj = dynCalls['viiijjj'] = wasmExports['$e']
      dynCall_viji = dynCalls['viji'] = wasmExports['af']
      dynCall_vijiii = dynCalls['vijiii'] = wasmExports['bf']
      dynCall_iiiiiiiii = dynCalls['iiiiiiiii'] = wasmExports['cf']
      dynCall_viiiiiiii = dynCalls['viiiiiiii'] = wasmExports['df']
      dynCall_iiiif = dynCalls['iiiif'] = wasmExports['ef']
      dynCall_viiiiiiiiiiiiiii = dynCalls['viiiiiiiiiiiiiii'] = wasmExports['ff']
      dynCall_viff = dynCalls['viff'] = wasmExports['gf']
      dynCall_viiffii = dynCalls['viiffii'] = wasmExports['hf']
      dynCall_viiffi = dynCalls['viiffi'] = wasmExports['jf']
      dynCall_viiiiiiiiii = dynCalls['viiiiiiiiii'] = wasmExports['kf']
      dynCall_fi = dynCalls['fi'] = wasmExports['lf']
      dynCall_viiffff = dynCalls['viiffff'] = wasmExports['mf']
      dynCall_viiiiij = dynCalls['viiiiij'] = wasmExports['nf']
      dynCall_vij = dynCalls['vij'] = wasmExports['of']
      dynCall_viiiiiffii = dynCalls['viiiiiffii'] = wasmExports['pf']
      dynCall_vif = dynCalls['vif'] = wasmExports['qf']
      dynCall_ddd = dynCalls['ddd'] = wasmExports['rf']
      dynCall_dddd = dynCalls['dddd'] = wasmExports['sf']
      dynCall_idd = dynCalls['idd'] = wasmExports['tf']
      dynCall_di = dynCalls['di'] = wasmExports['uf']
      dynCall_jiiiijiiiii = dynCalls['jiiiijiiiii'] = wasmExports['vf']
      dynCall_viiij = dynCalls['viiij'] = wasmExports['wf']
      dynCall_viid = dynCalls['viid'] = wasmExports['xf']
      dynCall_vidd = dynCalls['vidd'] = wasmExports['yf']
      dynCall_vifd = dynCalls['vifd'] = wasmExports['zf']
      dynCall_viiiiiiiiiii = dynCalls['viiiiiiiiiii'] = wasmExports['Af']
      dynCall_iiif = dynCalls['iiif'] = wasmExports['Bf']
      dynCall_jiii = dynCalls['jiii'] = wasmExports['Cf']
      dynCall_fff = dynCalls['fff'] = wasmExports['Df']
      dynCall_viifii = dynCalls['viifii'] = wasmExports['Ef']
      dynCall_fii = dynCalls['fii'] = wasmExports['Ff']
      dynCall_jjj = dynCalls['jjj'] = wasmExports['Gf']
      dynCall_iiiiiiiiii = dynCalls['iiiiiiiiii'] = wasmExports['Hf']
      dynCall_viiiiiiiii = dynCalls['viiiiiiiii'] = wasmExports['If']
      dynCall_viiiffii = dynCalls['viiiffii'] = wasmExports['Jf']
      dynCall_iiiiiffi = dynCalls['iiiiiffi'] = wasmExports['Kf']
      dynCall_viiiiiff = dynCalls['viiiiiff'] = wasmExports['Lf']
      dynCall_viiiiiiiiiiiii = dynCalls['viiiiiiiiiiiii'] = wasmExports['Mf']
      dynCall_viiiiiiiiiiii = dynCalls['viiiiiiiiiiii'] = wasmExports['Nf']
      dynCall_viiiiiiiiiiiiiiiii = dynCalls['viiiiiiiiiiiiiiiii'] = wasmExports['Of']
      dynCall_iifff = dynCalls['iifff'] = wasmExports['Pf']
      dynCall_iiff = dynCalls['iiff'] = wasmExports['Qf']
      dynCall_iiifiii = dynCalls['iiifiii'] = wasmExports['Rf']
      dynCall_iiffi = dynCalls['iiffi'] = wasmExports['Sf']
      dynCall_iiffii = dynCalls['iiffii'] = wasmExports['Tf']
      dynCall_viiiiiiiiiiiiii = dynCalls['viiiiiiiiiiiiii'] = wasmExports['Uf']
      dynCall_iif = dynCalls['iif'] = wasmExports['Vf']
      dynCall_viijii = dynCalls['viijii'] = wasmExports['Wf']
      dynCall_iiiji = dynCalls['iiiji'] = wasmExports['Xf']
      dynCall_viiif = dynCalls['viiif'] = wasmExports['Yf']
      dynCall_viiifiii = dynCalls['viiifiii'] = wasmExports['Zf']
      dynCall_fiif = dynCalls['fiif'] = wasmExports['_f']
      dynCall_iiiifi = dynCalls['iiiifi'] = wasmExports['$f']
      dynCall_iiiifiii = dynCalls['iiiifiii'] = wasmExports['ag']
      dynCall_iiifi = dynCalls['iiifi'] = wasmExports['bg']
      dynCall_viiiif = dynCalls['viiiif'] = wasmExports['cg']
      dynCall_viiiifii = dynCalls['viiiifii'] = wasmExports['dg']
      dynCall_dii = dynCalls['dii'] = wasmExports['eg']
      dynCall_vifi = dynCalls['vifi'] = wasmExports['fg']
      dynCall_vidi = dynCalls['vidi'] = wasmExports['gg']
      dynCall_viiiji = dynCalls['viiiji'] = wasmExports['hg']
      dynCall_viiji = dynCalls['viiji'] = wasmExports['ig']
      dynCall_vijjj = dynCalls['vijjj'] = wasmExports['jg']
      dynCall_vj = dynCalls['vj'] = wasmExports['kg']
      dynCall_viij = dynCalls['viij'] = wasmExports['lg']
      dynCall_jiji = dynCalls['jiji'] = wasmExports['mg']
      dynCall_iidiiii = dynCalls['iidiiii'] = wasmExports['ng']
      dynCall_iiiiij = dynCalls['iiiiij'] = wasmExports['og']
      dynCall_iiiiid = dynCalls['iiiiid'] = wasmExports['pg']
      dynCall_iiiiijj = dynCalls['iiiiijj'] = wasmExports['qg']
      dynCall_iiiiiiii = dynCalls['iiiiiiii'] = wasmExports['rg']
      dynCall_iiiiiijj = dynCalls['iiiiiijj'] = wasmExports['sg']
      _asyncify_start_unwind = wasmExports['tg']
      _asyncify_stop_unwind = wasmExports['ug']
      _asyncify_start_rewind = wasmExports['vg']
      _asyncify_stop_rewind = wasmExports['wg']
      memory = wasmMemory = wasmExports['tc']
    ...
    var _kVersionStampPrecookedClientInfoStr = (Module['_kVersionStampPrecookedClientInfoStr'] =
      9104)
    var wasmImports = {
      rc: DefaultErrorReporter,
      qc: GetAdapterArchitecture,
      pc: GetAdapterDescription,
      oc: GetAdapterDeviceName,
      nc: GetAdapterVendor,
      lc: JsGetDeviceMaxSubgroupSize,
      kc: JsGetDeviceMinSubgroupSize,
      jc: JsOnEmptyPacketListener,
      pa: JsOnSimpleListenerBinaryArray,
      ic: JsOnSimpleListenerBool,
      hc: JsOnSimpleListenerDouble,
      gc: JsOnSimpleListenerFloat,
      fc: JsOnSimpleListenerInt,
      ec: JsOnSimpleListenerString,
      dc: JsOnSimpleListenerUint,
      p: JsOnVectorFinishedListener,
      cc: JsOnVectorListenerBool,
      bc: JsOnVectorListenerDouble,
      ac: JsOnVectorListenerFloat,
      $b: JsOnVectorListenerInt,
      _b: JsOnVectorListenerProto,
      Zb: JsOnVectorListenerString,
      Yb: JsOnVectorListenerUint,
      oa: JsProgressListener,
      K: JsWrapErrorListener,
      g: JsWrapSimpleListeners,
      Xb: ThrowError,
      na: UseBottomLeftGpuOrigin,
      sc: __asyncjs__CallReadDataFn,
      mc: __asyncjs__InvokeReadDataFn,
      J: __asyncjs__ReadBufferDataJs,
      Da: __asyncjs__mediapipe_map_buffer_jspi,
      Wb: ___cxa_throw,
      Vb: ___syscall_dup,
      Ub: ___syscall_faccessat,
      ma: ___syscall_fcntl64,
      Tb: ___syscall_fstat64,
      ...
      Mb: ___syscall_renameat,
      Lb: ___syscall_stat64,
      Fb: __abort_js,
      Qa: __embind_register_bigint,
      Eb: __embind_register_bool,
      Db: __embind_register_emval,
      ja: __embind_register_float,
      ...
      Ab: __tzset_js,
      Sa: _clock_time_get,
      zb: custom_emscripten_dbgn,
      s: _emscripten_asm_const_int,
      yb: _emscripten_date_now,
      H: _emscripten_errn,
      xb: _emscripten_get_heap_max,
      b: _emscripten_get_now,
      fa: _emscripten_has_asyncify,
      wb: _emscripten_outn,
      vb: _emscripten_pc_get_function,
      ub: _emscripten_resize_heap,
      ea: _emscripten_stack_snapshot,
      tb: _emscripten_stack_unwind_buffer,
      sb: _emscripten_webgl_create_context,
      rb: _emscripten_webgl_destroy_context,
      qb: _emscripten_webgl_get_context_attributes,
      r: _emscripten_webgl_get_current_context,
      pb: _emscripten_webgl_make_context_current,
      da: _emscripten_webgpu_get_device,
      ob: _emwgpuBufferDestroy,
      nb: _emwgpuBufferGetMappedRange,
      mb: _emwgpuBufferUnmap,
      lb: _emwgpuBufferWriteMappedRange,
      f: _emwgpuDelete,
      kb: _emwgpuDeviceCreateBuffer,
      Ka: _emwgpuDeviceCreateComputePipelineAsync,
      ...
      Hb: _proc_exit,
      Gb: _random_get,
      Ia: _wgpuBufferGetSize,
      Ha: _wgpuBufferGetUsage,
      j: _wgpuCommandEncoderBeginComputePass,
      Ga: _wgpuCommandEncoderCopyBufferToBuffer,
      R: _wgpuCommandEncoderCopyTextureToBuffer,
      Q: _wgpuCommandEncoderCopyTextureToTexture,
      d: _wgpuCommandEncoderFinish,
      Fa: _wgpuCommandEncoderResolveQuerySet,
      P: _wgpuComputePassEncoderDispatchWorkgroups,
      i: _wgpuComputePassEncoderEnd,
      Ca: _wgpuComputePassEncoderSetBindGroup,
      O: _wgpuComputePassEncoderSetPipeline,
      ...
      qa: _wgpuTextureGetFormat,
      M: _wgpuTextureGetHeight,
      L: _wgpuTextureGetWidth
    }
    function applySignatureConversions(wasmExports) {
      ...
      wasmExports['Cc'] = makeWrapper_pp(wasmExports['Cc'])
      wasmExports['Nd'] = makeWrapper_pp(wasmExports['Nd'])
      wasmExports['we'] = makeWrapper_ppp(wasmExports['we'])
      wasmExports['xe'] = makeWrapper_ppp(wasmExports['xe'])
      wasmExports['Ae'] = makeWrapper_pp(wasmExports['Ae'])
      wasmExports['Be'] = makeWrapper_p(wasmExports['Be'])
